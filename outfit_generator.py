...
async def generate_outfit_images(prompts):
    """Generate outfit images using AI."""
...
async def post_outfits_to_twitter(outfits):
    ...
    try:
        ...
        # Intro tweet
        intro_text = "🎨 AI Fashion Showcase! 🤖 Generated 4 unique outfits with AI ✨\n\nEach look is worn by stunning models in perfect settings! 👇 #AIFashion #FashionAI #AIOutfits #Fashion #Outfits"
        ...
        # Outro tweet
        outro_text = "🤖 All outfits generated by AI! Each look features real models in stunning settings 💃\n\nWhich outfit would you rock? 💭\n\n#FashionTech #AIArt #OutfitInspo"
        client.create_tweet(
